...
csignals = {
    ...
    # TODO
    SVUNPACK:[ Y, BR_N , OP1_RS1, OP2_X, OEN_1, OEN_1, ALU_SVUNPACK , WB_ALU, REN_1, MEN_0, M_X , MT_X, ],
    SVPACK:  [ Y, BR_N , OP1_RS1, OP2_RS2, OEN_1, OEN_1, ALU_SVPACK , WB_ALU, REN_1, MEN_0, M_X , MT_X, ],
    SVBRDCST:[ Y, BR_N , OP1_RS1, OP2_X, OEN_1, OEN_1, ALU_SVBRDCST , WB_ALU, REN_1, MEN_0, M_X , MT_X, ],
    SVADDI:  [ Y, BR_N , OP1_RS1, OP2_IMI, OEN_1, OEN_0, ALU_SVADDI , WB_ALU, REN_1, MEN_0, M_X , MT_X, ],
    SVADD:   [ Y, BR_N , OP1_RS1, OP2_RS2, OEN_1, OEN_1, ALU_SVADD , WB_ALU, REN_1, MEN_0, M_X , MT_X, ],
    SVSUB:   [ Y, BR_N , OP1_RS1, OP2_RS2, OEN_1, OEN_1, ALU_SVSUB , WB_ALU, REN_1, MEN_0, M_X , MT_X, ],
    SVMUL:   [ Y, BR_N , OP1_RS1, OP2_RS2, OEN_1, OEN_1, ALU_SVMUL , WB_ALU, REN_1, MEN_0, M_X , MT_X, ],
}
