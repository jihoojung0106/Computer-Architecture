...
# Custom extensions (vector operations)
SVUNPACK    = WORD(0b00000000000000000000000000001011)
SVPACK      = WORD(0b00000000000000000001000000001011)
SVBRDCST    = WORD(0b00000000000000000010000000001011)
SVADDI      = WORD(0b00000000000000000011000000001011)
SVADD       = WORD(0b00000000000000000100000000001011)
SVSUB       = WORD(0b00000000000000000101000000001011)
SVMUL       = WORD(0b00000000000000000110000000001011)
...
# Custom extensions (vector operations)
SVUNPACK_MASK = WORD(0b11111111111100000111000001111111)
SVPACK_MASK   = R_MASK
SVBRDCST_MASK = SVUNPACK_MASK
SVADDI_MASK   = WORD(0b00000000000000000111000001111111)
SVADD_MASK    = R_MASK
SVSUB_MASK    = R_MASK
SVMUL_MASK    = R_MASK
...
isa         = { 
    ...
    SVUNPACK:["svunpack",   SVUNPACK_MASK,R_TYPE,CL_ALU,],
    SVPACK  :["svpack",     SVPACK_MASK  ,R_TYPE,CL_ALU,],
    SVBRDCST:["svbrdcst",   SVBRDCST_MASK,R_TYPE,CL_ALU,],
    SVADDI  :["svaddi",     SVADDI_MASK  ,I_TYPE,CL_ALU,],
    SVADD   :["svadd",      SVADD_MASK   ,R_TYPE,CL_ALU,],
    SVSUB   :["svsub",      SVSUB_MASK   ,R_TYPE,CL_ALU,],
    SVMUL   :["svmul",      SVMUL_MASK   ,R_TYPE,CL_ALU,],
