...
class EX(Pipe):
    ...
    def log(self):
        ...
        ALU_OPS = {
            ...
            ALU_SVUNPACK : f'# {self.alu_out:#010x} <-unpack {self.op1_data:#010x} ',
            ALU_SVPACK : f'# {self.alu_out:#010x} <- pack {self.op1_data:#010x} with {self.alu2_data:#010x}',
            ALU_SVBRDCST : f'# {self.alu_out:#010x} <- broadcast {self.op1_data:#010x} ',
            ALU_SVADDI : f'# {self.alu_out:#010x} <- vector add {self.op1_data:#010x} and {self.alu2_data:#010x}',
            ALU_SVADD : f'# {self.alu_out:#010x} <- vector add {self.op1_data:#010x} and {self.alu2_data:#010x}',
            ALU_SVSUB : f'# {self.alu_out:#010x} <- vector sub {self.op1_data:#010x}  {self.alu2_data:#010x}',
            ALU_SVMUL : f'# {self.alu_out:#010x} svmul {self.op1_data:#010x} * {self.alu2_data:#010x}',
        }
